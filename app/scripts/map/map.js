      ...
      link: function (scope, element, attrs) {
        ...
        world_map = new Datamap({
          ...
          geographyConfig: {
            ...
            popupOnHover: true,
            highlightBorderColor: '#bbb',
            highlightFillColor: '#EB62A0',
            borderColor: '#eee'
          },
          bubbleConfig: {
            borderWidth: 0,
          ...
          svgOptions:{
            ...
            'width':width,
            'height':height,
            'style':'background:#DDD; border: 0px solid #000'
          },
...
var addBubbles = function(bubbles) {
  ...
  var options = this.options.bubbleConfig;
  ...
  .on('mouseover', function(datum) {
    var hoverover = $(mapEl).find('.datamaps-hoverover');
    var eventData = {
      data: datum
    };
    ...
    hoverover.data('width', hoverover.width());
  ...
  .on('mouseout', function(datum) {
    $(mapEl).find('.datamaps-hoverover').hide();
    var eventData = {
      data: datum
    };
