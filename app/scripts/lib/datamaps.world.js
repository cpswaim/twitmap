(function() {
  ...
  function addContainer( element, width, height ) {
  ...
  ***************************************/
  ...
  function Datamap( options ) {
    ...
    this.options.svgOptions = defaults(options.svgOptions, defaultOptions.svgOptions)

    //add the SVG container
    if ( d3.select( this.options.element ).select('svg').length > 0 ) {
      var svg = addContainer.call(this, this.options.element, this.options.svgOptions.width, this.options.svgOptions.height );
      for(key in this.options.svgOptions){
        svg.attr(key, this.options.svgOptions[key]);
      }
    }
